...
public class Animation {
    ...
    public static func swipe(orientation: Orientation, direction : Direction, inView view: UIView, update: @escaping () -> ()) {
...
public class UIViewControllerAnimatorInteractive : UIPercentDrivenInteractiveTransition {
...
public class UIViewControllerAnimator: NSObject, UIViewControllerAnimatedTransitioning  {
    var direction: Animation.Direction!
    
    static let animationDuration = 0.7
    
    public func transitionDuration(using transitionContext: UIViewControllerContextTransitioning?) -> TimeInterval {
        return UIViewControllerAnimator.animationDuration
    }
    ...
    public func animateTransition(using transitionContext: UIViewControllerContextTransitioning) {
        ...
        UIView.animate(withDuration: UIViewControllerAnimator.animationDuration, delay: 0, options: [], animations: {
                        var vcFrame = finalFrame
